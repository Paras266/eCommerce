...
export const Cart = () => {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 border-black-200 ">
        <div className="mt-20 ">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 m-3">Cart</h1>
                ...
                <li key={product.id} className="flex py-6">
                  ...
                  <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 items-end justify-between text-sm">
                      <div className="text-black-500 text-1xl ">Qty
                        <select>
                          <option>1</option>
                          <option>2</option>
                          <option>3</option>
