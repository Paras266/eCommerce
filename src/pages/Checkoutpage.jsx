...
export const Checkoutpage = ()=>{
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-slate-500">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
        <div className="lg:col-span-2 bg-slate-400">
        ...
        <div className="lg:col-span-2 ">
          <div className="mx-auto mt-12 bg-white max-w-7xl px-5 sm:px-0 lg:px-0 ">
